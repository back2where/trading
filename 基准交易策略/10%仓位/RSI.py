...
if __name__ == '__main__':
    ...
    df = pd.read_excel(r'C:\Users\chen\OneDrive\科研\论文写作\强化学习\数据\crude oil price(2015.1-2022.6).xlsx', sheet_name='WTI')
    ...
    cerebro.addsizer(bt.sizers.FixedSize, stake=100)  # 铁矿石stake=100 , HBEA=500, oil=100


    # Set the commission
    cerebro.broker.setcommission(commission=0.000)  # 铁矿石"万1"， HBEA“千分5”， oil为"0"
    ...
    PV_pd.to_csv(r'C:\Users\chen\OneDrive\科研\论文写作\强化学习\实证结果\Oil\RSI.csv')
